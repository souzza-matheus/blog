...
const experiences = [
  {
    ...
    description: [
      ...
      'Atuação como suporte técnico , investigando e resolvendo incidentes complexos em produção, garantindo a continuidade dos serviços e a satisfação do cliente.',
